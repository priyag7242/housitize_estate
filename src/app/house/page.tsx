    ...
    <div>
      ...
      <div className="w-full bg-white flex flex-col justify-center items-center my-16">
        <p className="mb-4 text-sm text-gray-700">
          Thousands of world&apos;s leading companies trues Demigod
        </p>
        <Marquee
          gradient={false}
          speed={50}
        ...
        <div className="bg-[#FDF8F7] p-8 lg:p-16 flex flex-col justify-center">
          <div className="max-w-xl">
            ...
            <p className="text-gray-600 mb-12">
              We provide exceptional service and support to help you find your dream home. Our team of experts is dedicated to ensuring a smooth and successful real estate experience, whether you&apos;re buying, selling, or renting. With a proven track record and trusted by thousands, we offer personalized solutions tailored to your needs.
      ...
      <Accordion type="single" collapsible className="w-full space-y-4">
        ...
        <AccordionItem value="item-2" className="rounded-lg px-6">
          <AccordionTrigger className="text-left hover:no-underline">Can I cancel at anytime?</AccordionTrigger>
          <AccordionContent>
        ...
        <AccordionItem value="item-3" className="rounded-lg px-6">
          ...
          <AccordionContent>
            Receipts are automatically sent to your registered email address immediately after purchase. You can also
            access them from your account dashboard.
          </AccordionContent>
        </AccordionItem>

        <AccordionItem value="item-4" className="rounded-lg px-6">
          <AccordionTrigger className="text-left hover:no-underline">Which license do I need?</AccordionTrigger>
          <AccordionContent>
            The license you need depends on your usage. We offer personal, business, and enterprise licenses. Contact
            our sales team for detailed information.
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="item-5" className="rounded-lg px-6">
          ...
          <AccordionContent>
            After purchase, you&apos;ll receive an email with download instructions. You can also access your purchased
            themes from your account dashboard.
          </AccordionContent>
        </AccordionItem>
      </Accordion>
    </section>
