    ...
    switch (category) {
      case "powershade solar roof":
        return {
          ...
          title: "PowerShade Solar Roof",
          desc: "An integrated solar roof that generates clean and renewable energy.",
        };
      case "structural safety":
        return {
          image: "/assets/images/land-hover.jpg",
          title: "Structural Safety",
          desc: "Ensuring the structural integrity and safety of your home.",
        };
      case "smart control":
        return {
          image: "/assets/images/school-hover.jpg",
          title: "Smart Control",
          desc: "Advanced smart home controls for efficient energy management.",
        };
      case "water management":
        return {
          image: "/assets/images/beachfront-hover.jpg",
          title: "Water Management",
          desc: "Efficient water management systems for sustainable living.",
        };
      case "energy storage":
        return {
          image: "/assets/images/land-hover.jpg",
          title: "Energy Storage",
          desc: "Reliable energy storage solutions for uninterrupted power supply.",
        };
      case "eco materials":
        return {
          image: "/assets/images/home-hover.jpg",
          title: "Eco Materials",
          desc: "Using eco-friendly materials for a sustainable home.",
        };
      default:
        return null;
    }
  ...
  return (
    <div>
        ...
        <div className="relative h-[50vh] md:h-[70vh] w-full mt-32">
          ...
          <div className="absolute inset-0">
            ...
            >
              ...
              <div className="absolute left-0 bottom-0 z-10 ml-8 mb-6 sm:ml-12 max-w-xl">
                <h1 className="text-2xl sm:text-5xl text-white tracking-wider mb-2">
                  {displayHoverImage(hoverCategory)?.title}
                </h1>
                <p className="text-xl sm:text-2xl text-white tracking-wider">
          ...
          <div className="overflow-x-auto rounded-b-2xl">
            <div className="flex gap-4 min-w-max">
              {features.map((feature, index) => (
                <div
                  key={index}
                  className="relative w-[250px] h-[90px] sm:w-[300px] sm:h-[110px] group cursor-pointer hover:scale-105 transition duration-300"
                  onMouseEnter={() =>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col hover:-translate-y-3 transition duration-500 bg-white rounded-lg shadow-sm hover:shadow-md">
            ...
            <div className="p-6 flex flex-col flex-grow">
              ...
              <button className="mt-auto w-full bg-gray-900 text-white py-3 px-4 rounded-md hover:bg-gray-800 transition-colors">
                Learn More
              </button>
            </div>
          </div>
      ...
      <div className="relative w-full min-h-[60vh] md:min-h-screen">
        ...
        <div className="relative z-10 container mx-auto px-4 md:px-6 lg:px-8 pt-20 md:pt-32">
